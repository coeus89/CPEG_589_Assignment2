...
from models.WGAN_Penalty import WGAN_PENALTY_Disc

SAVE_PER_TIMES = 100

class WGAN_PENALTY(DCGAN_MODEL):
    def __init__(self, channels, generator_iters, batch_size):
        ...
        self.D = WGAN_PENALTY_Disc(channels=channels)
        self.C = channels
        self.G_filename = './WGAN_PENALTY_generator.pkl'
        self.D_filename = './WGAN_PENALTY_discriminator.pkl'
        self.img_filename = 'WGAN_PENALTY_model_image.png'
    ...
    def train(self, train_loader):
        ...
        for g_iter in range(self.generator_iters):
            ...
            if (g_iter) % SAVE_PER_TIMES == 0:
                ...
                utils.save_image(grid, 'training_result_images/img_WGAN_PENALTY_generatori_iter_{}.png'.format(str(g_iter).zfill(3)))
